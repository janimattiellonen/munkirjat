...
(function($) {
  ...
  BsmSelect.prototype = {
    ...
    buildDom: function() {
      ...
      if($.isFunction(o.customActionFunction) )
      {  
    	  this.$list.delegate('.' + o.customActionClass, 'click', o.customActionFunction);
      }
    ...
    addListItem: function($bsmOpt) {
      ...
      $('.' + o.listItemClass).append($('<a>', { href: '#', 'class': o.customActionClass, html: "Info" }).attr('style', 'position: absolute; top: 0; padding: 5px; right: 70px;'));
